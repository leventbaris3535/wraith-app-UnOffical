...
🔧 1. Kaynaktan Kurulum (EXE Oluşturmak İsteyenler İçin)
...
Bu repository’deki tüm dosyaları indirin veya projeyi klonlayın

Proje klasöründe bulunan build.bat dosyasına çift tıklayın

Gerekirse Windows sizden Yönetici izni isteyecektir (otomatik olarak)
...
İşlem tamamlandığında exe dosyanız oluşturulur
...
GitHub sayfasındaki Releases bölümüne gidin
...
Electron (varsa düzenleyebilirsin)
